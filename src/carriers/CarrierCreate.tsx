...
const CarrierCreate = (props: any) => {
    const classes = useStyles();
    // const translate = useTranslate();
    return (
        <Create {...props}>
            <TabbedForm>
                <FormTab label="resources.carriers.tabs.carrier">
                    <SectionTitle label="resources.carriers.newlabel" />
                    <TextInput
                        autoFocus
                        source="title"
                ...
                <FormTab path="description" label="resources.carriers.tabs.description">
                    <TextInput multiline fullWidth source="descript" label="" />
                </FormTab>
                <FormTab path="calc" label="resources.carriers.tabs.calc">
                    <TextInput multiline fullWidth source="calc" label="" />
                </FormTab>
                <FormTab path="content" label="resources.carriers.tabs.content">
                    <ImagesWithContent imagesSource="images" contentSource="content"/>
                </FormTab>
                <FormTab path="template" label="resources.carriers.tabs.template">
